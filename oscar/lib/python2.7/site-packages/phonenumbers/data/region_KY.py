...
PHONE_METADATA_KY = PhoneMetadata(id='KY', country_code=1, international_prefix='011',
    general_desc=PhoneNumberDesc(national_number_pattern='[3589]\\d{9}', possible_length=(10,), possible_length_local_only=(7,)),
    ...
    premium_rate=PhoneNumberDesc(national_number_pattern='900[2-9]\\d{6}|345976\\d{4}', example_number='9002345678', possible_length=(10,)),
