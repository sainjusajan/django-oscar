...
PHONE_METADATA_ZA = PhoneMetadata(id='ZA', country_code=27, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[1-79]\\d{8}|8\\d{4,8}', possible_length=(5, 6, 7, 8, 9)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:6\\d|7[0-46-9])\\d{7}|8(?:[1-4]\\d{1,5}|5\\d{5})\\d{2}', example_number='711234567', possible_length=(5, 6, 7, 8, 9)),
    toll_free=PhoneNumberDesc(national_number_pattern='80\\d{7}', example_number='801234567', possible_length=(9,)),
    premium_rate=PhoneNumberDesc(national_number_pattern='86[2-9]\\d{6}|9[0-2]\\d{7}', example_number='862345678', possible_length=(9,)),
