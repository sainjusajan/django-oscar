...
PHONE_METADATA_SN = PhoneMetadata(id='SN', country_code=221, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[3789]\\d{8}', possible_length=(9,)),
    ...
    voip=PhoneNumberDesc(national_number_pattern='39[01]\\d{6}|3392\\d{5}|93330\\d{4}', example_number='933301234', possible_length=(9,)),
