...
PHONE_METADATA_AD = PhoneMetadata(id='AD', country_code=376, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:3\\d|6(?:[0-8]|90\\d{2}))\\d{4}', example_number='312345', possible_length=(6, 9)),
    ...
    no_international_dialling=PhoneNumberDesc(national_number_pattern='1800\\d{4}', example_number='18000000', possible_length=(8,)),
