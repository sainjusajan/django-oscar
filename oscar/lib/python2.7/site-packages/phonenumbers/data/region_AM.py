...
PHONE_METADATA_AM = PhoneMetadata(id='AM', country_code=374, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:4[1349]|55|77|88|9[1-9])\\d{6}', example_number='77123456', possible_length=(8,)),
    ...
    number_format=[NumberFormat(pattern='(\\d{2})(\\d{6})', format='\\1 \\2', leading_digits_pattern=['1|47'], national_prefix_formatting_rule='(0\\1)'),
        NumberFormat(pattern='(\\d{2})(\\d{6})', format='\\1 \\2', leading_digits_pattern=['4[1349]|[5-7]|88|9[1-9]'], national_prefix_formatting_rule='0\\1'),
