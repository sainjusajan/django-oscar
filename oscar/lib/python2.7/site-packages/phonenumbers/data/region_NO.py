...
PHONE_METADATA_NO = PhoneMetadata(id='NO', country_code=47, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='0\\d{4}|[2-9]\\d{7}', possible_length=(5, 8)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:4[015-8]|5[89]|87|9\\d)\\d{6}', example_number='40612345', possible_length=(8,)),
