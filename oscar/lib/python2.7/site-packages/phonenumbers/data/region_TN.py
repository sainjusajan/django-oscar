...
PHONE_METADATA_TN = PhoneMetadata(id='TN', country_code=216, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='3(?:[012]\\d|6[0-4]|91)\\d{5}|7\\d{7}|81200\\d{3}', example_number='71234567', possible_length=(8,)),
    mobile=PhoneNumberDesc(national_number_pattern='(?:[259]\\d|4[0-6])\\d{6}', example_number='20123456', possible_length=(8,)),
