...
PHONE_METADATA_PF = PhoneMetadata(id='PF', country_code=689, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='4\\d{5,7}|8\\d{7}', possible_length=(6, 8)),
    fixed_line=PhoneNumberDesc(national_number_pattern='4(?:[09][45689]\\d|4)\\d{4}', example_number='40412345', possible_length=(6, 8)),
    mobile=PhoneNumberDesc(national_number_pattern='8[79]\\d{6}', example_number='87123456', possible_length=(8,)),
    no_international_dialling=PhoneNumberDesc(national_number_pattern='44\\d{4}', example_number='441234', possible_length=(6,)),
