...
PHONE_METADATA_UA = PhoneMetadata(id='UA', country_code=380, international_prefix='00',
    ...
    number_format=[NumberFormat(pattern='([3-9]\\d)(\\d{3})(\\d{4})', format='\\1 \\2 \\3', leading_digits_pattern=['[38]9|4(?:[45][0-5]|87)|5(?:0|6[37]|7[37])|6[36-8]|7|9[1-9]', '[38]9|4(?:[45][0-5]|87)|5(?:0|6(?:3[14-7]|7)|7[37])|6[36-8]|7|9[1-9]'], national_prefix_formatting_rule='0\\1'),
