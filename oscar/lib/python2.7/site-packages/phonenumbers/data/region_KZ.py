...
PHONE_METADATA_KZ = PhoneMetadata(id='KZ', country_code=7, international_prefix='810',
    general_desc=PhoneNumberDesc(national_number_pattern='(?:33\\d|7\\d{2}|80[089])\\d{7}', possible_length=(10,)),
    ...
    no_international_dialling=PhoneNumberDesc(national_number_pattern='751\\d{7}', example_number='7511234567', possible_length=(10,)),
