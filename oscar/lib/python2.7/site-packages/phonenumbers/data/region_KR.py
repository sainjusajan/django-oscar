...
PHONE_METADATA_KR = PhoneMetadata(id='KR', country_code=82, international_prefix='00(?:[124-68]|3\\d{2}|7(?:[0-8]\\d|9[0-79]))',
    general_desc=PhoneNumberDesc(national_number_pattern='007\\d{9,11}|[1-7]\\d{3,9}|8\\d{8}', possible_length=(4, 5, 6, 8, 9, 10, 12, 13, 14), possible_length_local_only=(3, 7)),
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:2|3[1-3]|[46][1-4]|5[1-5])(?:1\\d{2,3}|[1-9]\\d{6,7})', example_number='22123456', possible_length=(4, 5, 6, 8, 9, 10), possible_length_local_only=(3, 7)),
    mobile=PhoneNumberDesc(national_number_pattern='1[0-26-9]\\d{7,8}', example_number='1000000000', possible_length=(9, 10)),
    toll_free=PhoneNumberDesc(national_number_pattern='(?:00798\\d{0,2}|80)\\d{7}', example_number='801234567', possible_length=(9, 12, 13, 14)),
    ...
    no_international_dialling=PhoneNumberDesc(national_number_pattern='00798\\d{7,9}', example_number='007981234567', possible_length=(12, 13, 14)),
    national_prefix='0',
