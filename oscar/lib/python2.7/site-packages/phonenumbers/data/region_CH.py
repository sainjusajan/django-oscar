...
PHONE_METADATA_CH = PhoneMetadata(id='CH', country_code=41, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[2-9]\\d{8}|860\\d{9}', possible_length=(9, 12)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='7[5-9]\\d{7}', example_number='781234567', possible_length=(9,)),
