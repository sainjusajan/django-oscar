...
PHONE_METADATA_ME = PhoneMetadata(id='ME', country_code=382, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[2-9]\\d{7,8}', possible_length=(8,), possible_length_local_only=(6,)),
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:20[2-8]|3(?:0[2-7]|[12][235-7]|3[24-7])|4(?:0[2-467]|1[267])|5(?:0[2467]|1[267]|2[2367]))\\d{5}', example_number='30234567', possible_length=(8,), possible_length_local_only=(6,)),
    mobile=PhoneNumberDesc(national_number_pattern='6(?:00\\d|3[024]\\d|6[0-25]\\d|[7-9]\\d{2})\\d{4}', example_number='67622901', possible_length=(8,)),
    toll_free=PhoneNumberDesc(national_number_pattern='80[0-258]\\d{5}', example_number='80080002', possible_length=(8,)),
