...
PHONE_METADATA_TO = PhoneMetadata(id='TO', country_code=676, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[02-8]\\d{4,6}', possible_length=(5, 7)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:7[578]|8[47-9])\\d{5}', example_number='7715123', possible_length=(7,)),
