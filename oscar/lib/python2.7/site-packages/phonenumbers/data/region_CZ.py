...
PHONE_METADATA_CZ = PhoneMetadata(id='CZ', country_code=420, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[2-8]\\d{8}|9\\d{8,11}', possible_length=(9, 10, 11, 12)),
    fixed_line=PhoneNumberDesc(national_number_pattern='2\\d{8}|(?:3[1257-9]|4[16-9]|5[13-9])\\d{7}', example_number='212345678', possible_length=(9,)),
    ...
    uan=PhoneNumberDesc(national_number_pattern='9(?:5\\d|7[234])\\d{6}', example_number='972123456', possible_length=(9,)),
