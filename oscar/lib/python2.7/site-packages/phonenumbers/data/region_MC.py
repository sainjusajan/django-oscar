...
PHONE_METADATA_MC = PhoneMetadata(id='MC', country_code=377, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[34689]\\d{7,8}', possible_length=(8, 9)),
    fixed_line=PhoneNumberDesc(national_number_pattern='870\\d{5}|9[2-47-9]\\d{6}', example_number='99123456', possible_length=(8,)),
    ...
    no_international_dialling=PhoneNumberDesc(national_number_pattern='870\\d{5}', example_number='87012345', possible_length=(8,)),
    national_prefix='0',
