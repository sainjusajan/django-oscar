...
PHONE_METADATA_SL = PhoneMetadata(id='SL', country_code=232, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[2-9]\\d{7}', possible_length=(8,), possible_length_local_only=(6,)),
    ...
    mobile=PhoneNumberDesc(national_number_pattern='(?:2[15]|3[03-5]|4[04]|5[05]|66|7[6-9]|8[08]|99)\\d{6}', example_number='25123456', possible_length=(8,)),
    national_prefix='0',
