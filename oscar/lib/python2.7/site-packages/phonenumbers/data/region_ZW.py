...
PHONE_METADATA_ZW = PhoneMetadata(id='ZW', country_code=263, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='2(?:[0-2457-9]\\d{3,8}|6(?:[14]\\d{7}|\\d{4}))|[13-79]\\d{4,9}|8[06]\\d{5,8}', possible_length=(5, 6, 7, 8, 9, 10), possible_length_local_only=(3, 4)),
    ...
    number_format=[NumberFormat(pattern='([49])(\\d{3})(\\d{2,4})', format='\\1 \\2 \\3', leading_digits_pattern=['4|9[2-9]'], national_prefix_formatting_rule='0\\1'),
        ...
        NumberFormat(pattern='([1-356]\\d)(\\d{3,5})', format='\\1 \\2', leading_digits_pattern=['1[3-9]|2[02569]|3[0-69]|5[05689]|6\\d'], national_prefix_formatting_rule='0\\1'),
