...
PHONE_METADATA_VN = PhoneMetadata(id='VN', country_code=84, international_prefix='00',
    ...
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:2(?:0[3-9]|1[0-689]|2[0-25-9]|3[2-9]|[48][2-7]|5[124-9]|6[0-39]|7[0-7]|9[0-4679])|4\\d|5(?:0[01]|[5-9])|6(?:[0-46-8]|5[01])|7[0235])\\d{7}|8(?:[2-5]\\d|6[236]|7[13])\\d{6}', example_number='2101234567', possible_length=(9, 10)),
    ...
    number_format=[NumberFormat(pattern='([17]99)(\\d{4})', format='\\1 \\2', leading_digits_pattern=['[17]99'], national_prefix_formatting_rule='0\\1', national_prefix_optional_when_formatting=True),
        ...
        NumberFormat(pattern='(\\d{2})(\\d{4})(\\d{3,4})', format='\\1 \\2 \\3', leading_digits_pattern=['2[48]|5[5-9]|6[0-46-8]|7[0235]'], national_prefix_formatting_rule='0\\1', national_prefix_optional_when_formatting=True),
        ...
        NumberFormat(pattern='(\\d{3})(\\d{4})(\\d{3})', format='\\1 \\2 \\3', leading_digits_pattern=['2[0-35-79]|50|65'], national_prefix_formatting_rule='0\\1', national_prefix_optional_when_formatting=True),
