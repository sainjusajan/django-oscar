...
PHONE_METADATA_BE = PhoneMetadata(id='BE', country_code=32, international_prefix='00',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='4(?:6[0135-8]|[79]\\d|8[3-9])\\d{6}', example_number='470123456', possible_length=(9,)),
    toll_free=PhoneNumberDesc(national_number_pattern='800\\d{5}', example_number='80012345', possible_length=(8,)),
    premium_rate=PhoneNumberDesc(national_number_pattern='(?:70[2-467]|90[0-79])\\d{5}', example_number='90123456', possible_length=(8,)),
    uan=PhoneNumberDesc(national_number_pattern='78\\d{6}', example_number='78123456', possible_length=(8,)),
    national_prefix='0',
