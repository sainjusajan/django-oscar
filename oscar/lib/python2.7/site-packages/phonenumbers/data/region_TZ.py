...
PHONE_METADATA_TZ = PhoneMetadata(id='TZ', country_code=255, international_prefix='00[056]',
    general_desc=PhoneNumberDesc(national_number_pattern='\\d{9}', possible_length=(7, 9)),
    fixed_line=PhoneNumberDesc(national_number_pattern='2[2-8]\\d{7}', example_number='222345678', possible_length=(7, 9)),
    ...
    no_international_dialling=PhoneNumberDesc(national_number_pattern='(?:8(?:[04]0|6[01])|90\\d)\\d{6}', example_number='800123456', possible_length=(9,)),
    national_prefix='0',
