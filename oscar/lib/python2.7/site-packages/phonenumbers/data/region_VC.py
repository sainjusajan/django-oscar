...
PHONE_METADATA_VC = PhoneMetadata(id='VC', country_code=1, international_prefix='011',
    ...
    mobile=PhoneNumberDesc(national_number_pattern='784(?:4(?:3[0-5]|5[45]|89|9[0-58])|5(?:2[6-9]|3[0-4]))\\d{4}', example_number='7844301234', possible_length=(10,), possible_length_local_only=(7,)),
