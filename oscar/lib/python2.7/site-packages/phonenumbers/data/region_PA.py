...
PHONE_METADATA_PA = PhoneMetadata(id='PA', country_code=507, international_prefix='00',
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='80[09]\\d{4}', example_number='8001234', possible_length=(7,)),
    premium_rate=PhoneNumberDesc(national_number_pattern='(?:779|8(?:55|60|7[78])|9(?:00|81))\\d{4}', example_number='8601234', possible_length=(7,)),
