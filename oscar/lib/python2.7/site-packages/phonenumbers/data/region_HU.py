...
PHONE_METADATA_HU = PhoneMetadata(id='HU', country_code=36, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='[1-9]\\d{7,8}', possible_length=(8, 9), possible_length_local_only=(6,)),
    fixed_line=PhoneNumberDesc(national_number_pattern='(?:1\\d|2[2-9]|3[2-7]|4[24-9]|5[2-79]|6[23689]|7[2-9]|8[2-57-9]|9[2-69])\\d{6}', example_number='12345678', possible_length=(8,), possible_length_local_only=(6,)),
    ...
    no_international_dialling=PhoneNumberDesc(national_number_pattern='[48]0\\d{6}', example_number='80123456', possible_length=(8,)),
    national_prefix='06',
