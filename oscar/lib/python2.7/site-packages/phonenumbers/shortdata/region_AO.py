...
PHONE_METADATA_AO = PhoneMetadata(id='AO', country_code=None, international_prefix=None,
    ...
    emergency=PhoneNumberDesc(national_number_pattern='11[235]', example_number='113', possible_length=(3,)),
    short_code=PhoneNumberDesc(national_number_pattern='11[235]', example_number='113', possible_length=(3,)),
    short_data=True)
