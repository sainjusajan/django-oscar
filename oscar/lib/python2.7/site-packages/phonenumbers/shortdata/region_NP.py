...
PHONE_METADATA_NP = PhoneMetadata(id='NP', country_code=None, international_prefix=None,
    ...
    emergency=PhoneNumberDesc(national_number_pattern='1(?:0[0-3]|12)', example_number='112', possible_length=(3,)),
    short_code=PhoneNumberDesc(national_number_pattern='1(?:0[0-3]|12)', example_number='112', possible_length=(3,)),
    short_data=True)
