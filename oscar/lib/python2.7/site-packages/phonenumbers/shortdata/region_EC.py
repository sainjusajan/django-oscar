...
PHONE_METADATA_EC = PhoneMetadata(id='EC', country_code=None, international_prefix=None,
    ...
    emergency=PhoneNumberDesc(national_number_pattern='1(?:0[12]|12)|911', example_number='911', possible_length=(3,)),
    short_code=PhoneNumberDesc(national_number_pattern='1(?:0[12]|12)|911', example_number='911', possible_length=(3,)),
    short_data=True)
