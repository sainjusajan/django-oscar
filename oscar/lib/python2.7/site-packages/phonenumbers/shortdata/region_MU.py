...
PHONE_METADATA_MU = PhoneMetadata(id='MU', country_code=None, international_prefix=None,
    ...
    emergency=PhoneNumberDesc(national_number_pattern='11[45]|99[59]', example_number='999', possible_length=(3,)),
    short_code=PhoneNumberDesc(national_number_pattern='1\\d{2,4}|8\\d{3}|99\\d', example_number='995', possible_length=(3, 4, 5)),
    short_data=True)
