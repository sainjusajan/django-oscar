...
PHONE_METADATA_RU = PhoneMetadata(id='RU', country_code=None, international_prefix=None,
    ...
    emergency=PhoneNumberDesc(national_number_pattern='0[1-3]|1(?:0[1-3]|12)', example_number='112', possible_length=(2, 3)),
    short_code=PhoneNumberDesc(national_number_pattern='0[1-4]|1(?:0[1-4]|12)', example_number='112', possible_length=(2, 3)),
    short_data=True)
