...
PHONE_METADATA_RS = PhoneMetadata(id='RS', country_code=None, international_prefix=None,
    ...
    emergency=PhoneNumberDesc(national_number_pattern='112|9[234]', example_number='112', possible_length=(2, 3)),
    short_code=PhoneNumberDesc(national_number_pattern='1[189]\\d{1,4}|9[234]', example_number='112', possible_length=(2, 3, 4, 5, 6)),
    short_data=True)
