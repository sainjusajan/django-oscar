...
PHONE_METADATA_HU = PhoneMetadata(id='HU', country_code=None, international_prefix=None,
    ...
    emergency=PhoneNumberDesc(national_number_pattern='1(?:0[457]|12)', example_number='112', possible_length=(3,)),
    short_code=PhoneNumberDesc(national_number_pattern='1(?:0[457]|1(?:2|6(?:000|1(?:11|23))))', example_number='112', possible_length=(3, 6)),
    short_data=True)
