...
PHONE_METADATA_TM = PhoneMetadata(id='TM', country_code=None, international_prefix=None,
    ...
    emergency=PhoneNumberDesc(national_number_pattern='0[1-3]', example_number='03', possible_length=(2,)),
    short_code=PhoneNumberDesc(national_number_pattern='0[1-3]', example_number='03', possible_length=(2,)),
    short_data=True)
