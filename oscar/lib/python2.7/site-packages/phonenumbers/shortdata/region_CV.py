...
PHONE_METADATA_CV = PhoneMetadata(id='CV', country_code=None, international_prefix=None,
    ...
    emergency=PhoneNumberDesc(national_number_pattern='13[012]', example_number='132', possible_length=(3,)),
    short_code=PhoneNumberDesc(national_number_pattern='13[012]', example_number='132', possible_length=(3,)),
    short_data=True)
