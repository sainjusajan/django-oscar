...
PHONE_METADATA_CI = PhoneMetadata(id='CI', country_code=None, international_prefix=None,
    ...
    carrier_specific=PhoneNumberDesc(national_number_pattern='4443', example_number='4443', possible_length=(4,)),
    sms_services=PhoneNumberDesc(national_number_pattern='4443', example_number='4443', possible_length=(4,)),
    short_data=True)
