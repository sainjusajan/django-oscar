...
PHONE_METADATA_MC = PhoneMetadata(id='MC', country_code=None, international_prefix=None,
    ...
    emergency=PhoneNumberDesc(national_number_pattern='1(?:12|[578])', example_number='112', possible_length=(2, 3)),
    short_code=PhoneNumberDesc(national_number_pattern='1(?:12|41|[578])', example_number='112', possible_length=(2, 3)),
    short_data=True)
