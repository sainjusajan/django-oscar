...
PHONE_METADATA_GP = PhoneMetadata(id='GP', country_code=None, international_prefix=None,
    ...
    emergency=PhoneNumberDesc(national_number_pattern='1[578]', example_number='18', possible_length=(2,)),
    short_code=PhoneNumberDesc(national_number_pattern='1[578]', example_number='18', possible_length=(2,)),
    short_data=True)
