...
PHONE_METADATA_CF = PhoneMetadata(id='CF', country_code=None, international_prefix=None,
    ...
    emergency=PhoneNumberDesc(national_number_pattern='1(?:1[78]|220)', example_number='1220', possible_length=(3, 4)),
    short_code=PhoneNumberDesc(national_number_pattern='1(?:1[478]|220)', example_number='117', possible_length=(3, 4)),
    short_data=True)
