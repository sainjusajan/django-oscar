...
PHONE_METADATA_DK = PhoneMetadata(id='DK', country_code=None, international_prefix=None,
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='116(?:00[06]|111)', example_number='116000', possible_length=(6,)),
    emergency=PhoneNumberDesc(national_number_pattern='11[24]', example_number='112', possible_length=(3,)),
    short_code=PhoneNumberDesc(national_number_pattern='1(?:1(?:[2-48]|6(?:00[06]|111))|8(?:01|1[0238]|28|30|5[13]|81))', example_number='112', possible_length=(3, 4, 6)),
    short_data=True)
