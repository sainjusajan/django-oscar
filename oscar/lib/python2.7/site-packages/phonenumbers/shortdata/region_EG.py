...
PHONE_METADATA_EG = PhoneMetadata(id='EG', country_code=None, international_prefix=None,
    general_desc=PhoneNumberDesc(national_number_pattern='[13]\\d{2,4}', possible_length=(3, 5)),
    ...
    carrier_specific=PhoneNumberDesc(national_number_pattern='34400', example_number='34400', possible_length=(5,)),
    sms_services=PhoneNumberDesc(national_number_pattern='34400', example_number='34400', possible_length=(5,)),
    short_data=True)
