...
PHONE_METADATA_MK = PhoneMetadata(id='MK', country_code=None, international_prefix=None,
    ...
    emergency=PhoneNumberDesc(national_number_pattern='1(?:12|9[234])', example_number='112', possible_length=(3,)),
    short_code=PhoneNumberDesc(national_number_pattern='1(?:12|9[234])', example_number='112', possible_length=(3,)),
    short_data=True)
